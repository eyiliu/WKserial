#ifndef NANOTECMOTOR_HH
#define NANOTECMOTOR_HH

/*NOTE
X axis: MotorID 0; external switch left port_in_f, right  port_in_e
Y axis: MOtorID 1; external siwtch down port_in_f, up  port_in_e
...
#define NANOTEC_REFERENCE_RUN_FORWARD   0b01
#define NANOTEC_REFERENCE_RUN_BACK      0b10
#define NANOTEC_NORMAL_RUN_FORWARD      0b0001
#define NANOTEC_NORMAL_RUN_BACK         0b0010
#define NANOTEC_NORMAL_RUN_STOP         0b0100
#define NANOTEC_NORMAL_RUN_IGNORE       0b1000
...
namespace nanotec
{
     ...
     */
  class NanotecMotor: public WKserial{
  public:
    NanotecMotor(std::string devpath);
    ~NanotecMotor();
