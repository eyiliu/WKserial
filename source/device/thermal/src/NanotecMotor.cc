...
nanotec::NanotecMotor::NanotecMotor(std::string devpath)
  :WKserial(devpath){
  connect();
  set_endline("\r");
  set_speed(115200);
...
bool nanotec::NanotecMotor::sendCommand(std::string & message, std::string & reply){
  std::string head("#");
